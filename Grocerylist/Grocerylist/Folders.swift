...
extension Folders {
  static var allFolders: [Folders] = [
    Folders(title: "Expired", products: [ GroceryProducts(name: "milk", identifer: 12344, categories: true), GroceryProducts(name: "egg", identifer: 1234467, categories: true)
                                          
    ]),  Folders(title: "New", products: [ GroceryProducts(name: "yam", identifer: 123448, categories: true), GroceryProducts(name: "butter", identifer: 12344867, categories: true) ])
  ]
}
//enum Folders {
